...
enum planck_keycodes { PLOVER = SAFE_RANGE, BACKLIT, EXT_PLV, LOCKWIN, C_ALT_D, SNAP_LFT, SNAP_RT, SNAP_TOP, SNAP_BTM};
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      | Alt  | GUI  |LowTab|Space |Enter |RaiBsp|Shift |      |      |LCKWIN|
 * `-----------------------------------------------------------------------------------'
 */
